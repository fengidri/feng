...
def save():
    json.dump( __INDEX,open(indexfile, 'w'))
    json.dump( __CLASS,open(classfile, 'w'))
    json.dump( __TAGS, open(tagsfile, 'w')) 
...
def add(title, content, cls='', tags=[], public=0):
    ...
    open(fp, 'wb').write(context.context2htmls(content.decode('utf8')))
